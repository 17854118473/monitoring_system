...
public class CodeGeneratorUtil {
    public static final String DB_URL = "jdbc:mysql://localhost:3306/db1?zeroDateTimeBehavior=convertToNull&useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&serverTimezone=UTC";
    public static final String DB_DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    public static final String BASE_PACKAGE_PATH = "com.sys.monitoring_system";
    ...
    public static void execute() {
        ...
        gc.setAuthor("Z");                                  // Mapper,Service等类注解中显示创建人信息
...
//        pc.setModuleName(scanner("模块名"));   // 模块名称
        ...
        */
        ...
        mpg.setCfg(cfg);
        //TemplateConfig templateConfig = new TemplateConfig().setController("templates/controller.java").setXml("templates/mapper.xml").setEntity("templates/entity.java").setService("templates/service.java").setServiceImpl("templates/serviceImpl.java");
